...
export const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#070B14] flex">
      <DynamicBackground variant="identity" />

      {/* Left panel — branding */}
      <div className="relative z-10 hidden lg:flex flex-col justify-center items-center w-1/2 p-16 overflow-hidden">
          ...
          <div className="bg-slate-800/50 border border-slate-700/60 rounded-2xl p-6 shadow-2xl">
            {tab === 'login' ? (
              <>
                ...
                <p className="text-slate-400 text-sm mb-6">Sign in with your local account to continue</p>
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    <label className="text-xs text-slate-400 uppercase tracking-wide mb-1.5 block">Email</label>
                    <div className="relative">
                      <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" />
                      <input type="email" placeholder="ahmed.khan@gmail.com" className={`${inputCls} pl-10`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type={showPass ? 'text' : 'password'} placeholder="Enter your password" className={`${inputCls} pl-10 pr-10`}
              ...
              <>
                ...
                <p className="text-slate-400 text-sm mb-6">Create an account for video verification in Pakistan</p>
                <form onSubmit={handleSignup} className="space-y-4">
                  <div>
                    <label className="text-xs text-slate-400 uppercase tracking-wide mb-1.5 block">Full Name</label>
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" />
                      <input type="text" placeholder="Ayesha Malik" className={`${inputCls} pl-10`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" />
                      <input type="email" placeholder="ayesha.malik@gmail.com" className={`${inputCls} pl-10`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" />
                      <input type={showPass ? 'text' : 'password'} placeholder="Create a strong password" className={`${inputCls} pl-10 pr-10`}
